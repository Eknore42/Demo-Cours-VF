...
namespace _420_476_Dev3_Nadon_Marc_Andre.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> compare(string login, string password)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("compare", loginParameter, passwordParameter);
        }
    
        public virtual int createUser(string firstname, string lastname, string login, string password)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("createUser", firstnameParameter, lastnameParameter, loginParameter, passwordParameter);
        }
    }
}
